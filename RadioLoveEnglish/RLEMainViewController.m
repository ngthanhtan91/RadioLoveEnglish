...
#import "RLEMainViewController.h"

@interface RLEMainViewController ()

@end

@implementation RLEMainViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.audioPlayer = [[RLEAudioPlayer alloc] init];
